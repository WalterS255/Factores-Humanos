        ...
        >
          {productCards.map((p) => (
            <li key={p.idVariante} className="group">
              ...
              {/*
               * WCAG 1.3.1: <article> envuelve TODA la tarjeta (imagen + info)
               * para que la relación semántica entre imagen y datos del producto
               * quede correctamente expresada en el árbol de accesibilidad.
               */}
              <article aria-label={`${p.name}, ${p.color}, talla ${p.size}`}>
                ...
                <div className="aspect-[3/4] bg-gray-100 overflow-hidden mb-4
                  ...
                  {p.image ? (
                    ...
                    <div
                      ...
                      role="img"
                      aria-label={`Sin imagen disponible para ${p.name}`}
                    >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {/* Stock — oculto visualmente para AT cuando agotado (ya anunciado arriba) */}
